...
typedef enum {
    AX_AWB_CCT_LIMIT_TYPE_CCT       = 0,   /* set Rg\Bg by CctRange */
    AX_AWB_CCT_LIMIT_TYPE_MANUAL    = 1,   /* set Rg\Bg by Manual */
    AX_AWB_CCT_LIMIT_TYPE_MAX
} AX_ISP_IQ_AWB_CCT_LIMIT_TYPE_E;
typedef struct
{
    AX_U8 nEnable;                             /* Accuracy:U1 Range:[0, 1] */
    AX_ISP_IQ_AWB_CCT_LIMIT_TYPE_E eType;      /* Cct limit type, 0: set Rg\Bg by CctRange; 1:set Rg\Bg by Manual */
    AX_U16 nLowCct;                            /* Accuracy:U14 Range:[0, 16000]; MinCct */
    AX_U16 nHighCct;                           /* Accuracy:U14 Range:[0, 16000]; MaxCct */
    AX_U32 nLowRgLimit;                        /* Accuracy:U4.20 Range:[0, 16777215 (16*1024*1024)] */
    AX_U32 nLowBgLimit;                        /* Accuracy:U4.20 Range:[0, 16777215 (16*1024*1024)] */
    AX_U32 nHighRgLimit;                       /* Accuracy:U4.20 Range:[0, 16777215 (16*1024*1024)] */
    AX_U32 nHighBgLimit;                       /* Accuracy:U4.20 Range:[0, 16777215 (16*1024*1024)] */
} AX_ISP_IQ_AWB_CCT_LIMIT_T;
...
//    AX_U32 nGreenCutConfid_100_Lx;                /* Accuracy:U22.10 Range:[0, 4294967295 (4*1024*1024*1024)] */
    ...
    /* Limit Cct Range Params */
    AX_ISP_IQ_AWB_CCT_LIMIT_T tCctLimit;
...
typedef struct
{
    AX_U32  nIrisType;           /* Accuracy: U32 0: FIXED TYPE; 1: DC-IRIS; 2: P-IRIS  */
