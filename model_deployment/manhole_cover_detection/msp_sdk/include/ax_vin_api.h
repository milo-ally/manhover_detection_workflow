...
#define AX_BLACK_LEVEL_CHN_MAX                              (4)
...
typedef struct _AX_ISP_FRAME_T_ {
    ...
    AX_U32              nWhiteLevel;
    AX_U32              nBlackLevel[AX_BLACK_LEVEL_CHN_MAX];
...
typedef enum _AX_VIN_PIPE_DUMP_NODE_E_ {
    ...
    AX_VIN_PIPE_DUMP_NODE_AICE,         /* write data from aice to ddr */
