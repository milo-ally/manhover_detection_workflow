...
/*****************************************************************************
*   Prototype    : AX_IVE_NPU_CreateMatMulHandle_Affinity
*   Description  : Create matrix mul handle for NPU engine with affinity setting
*   Parameters   : AX_IVE_MATMUL_HANDLE        *pHandle              Return MatMul handle.
*                  AX_IVE_NPU_MATMUL_CTRL_AF_T    *pstMatMulCtrl        Control parameter.
*   Return Value : AX_SUCCESS: Success;Error codes: Failure.
*   Spec         :
*
*****************************************************************************/
AX_S32 AX_IVE_NPU_CreateMatMulHandle_Affinity(AX_IVE_MATMUL_HANDLE *pHandle, AX_IVE_NPU_MATMUL_CTRL_AF_T *pstMatMulCtrl);
