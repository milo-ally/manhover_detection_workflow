...
typedef struct {
    ...
    AX_S32  DefaultDist;             //Default initial object distance
...
typedef struct {
    AX_S32  tZoom1MoveStep;
    AX_S32  tZoom1MoveDirection;
    AX_S32  tZoom2MoveStep;
    AX_S32  tZoom2MoveDirection;
} AX_LENS_AF_ZOOM_MOVE_T;
