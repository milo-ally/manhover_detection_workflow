...
{
    AX_VOID*                            pstVirAddr[AX_AVS_PIPE_NUM - 1][AX_AVS_PYRA_NUM];
    AX_U32                              s32MaskSize[AX_AVS_PIPE_NUM - 1][AX_AVS_PYRA_NUM];
} AX_AVS_GRP_MASK_T;
...
typedef struct axAVS_GRP_ATTR_T
{
    ...
    AX_U32                      u32MaskPyraNum; /* RW; Range:must set 1 or AX_AVS_PYRA_NUM; Number of mask pyramid. */
