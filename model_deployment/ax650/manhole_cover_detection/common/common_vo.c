...
static AX_VO_SYNC_INFO_T g_stSyncInfos[SAMPLE_VO_SYNC_USER_MAX] = {
    /* 0 - 720x480@60 */
    {.bIop = AX_TRUE, .u16Vact = 480, .u16Vbb = 30, .u16Vfb = 9, .u16Hact = 720, .u16Hbb = 57, .u16Hfb = 19, .u16Hpw = 62, .u16Vpw = 6, .u32Pclk = 27000, .bIdv = 1, .bIhs = 1, .bIvs = 1},
    /* 1 - 720x576@60 */
    {.bIop = AX_TRUE, .u16Vact = 576, .u16Vbb = 14, .u16Vfb = 20, .u16Hact = 720, .u16Hbb = 60, .u16Hfb = 22, .u16Hpw = 62, .u16Vpw = 15, .u32Pclk = 27000, .bIdv = 1, .bIhs = 1, .bIvs = 1},
    /* 2 - 800x480@60 */
    {.bIop = AX_TRUE, .u16Vact = 480, .u16Vbb = 29, .u16Vfb = 13, .u16Hact = 800, .u16Hbb = 40, .u16Hfb = 40, .u16Hpw = 48, .u16Vpw = 3, .u32Pclk = 29232, .bIdv = 1, .bIhs = 1, .bIvs = 1},
    /* 3 - 640x480@60 */
    {.bIop = AX_TRUE, .u16Vact = 480, .u16Vbb = 23, .u16Vfb = 10, .u16Hact = 640, .u16Hbb = 60, .u16Hfb = 96, .u16Hpw = 62, .u16Vpw = 12, .u32Pclk = 27000, .bIdv = 1, .bIhs = 1, .bIvs = 1},
    /* 4 - 720x480I60 */
    {.bIop = AX_FALSE, .u16Vact = 240, .u16Vbb = 15, .u16Vfb = 5, .u16Bvact = 240, .u16Bvbb = 15, .u16Bvfb = 4, .u16Hact = 720, .u16Hbb = 57, .u16Hfb = 19, .u16Hpw = 62, .u16Vpw = 6, .u32Pclk = 13500, .bIdv = 1, .bIhs = 1, .bIvs = 1},
    /* 5 - NTSC 720x480I30 */
    {.bIop = AX_FALSE, .u16Vact = 240, .u16Vbb = 15, .u16Vfb = 5, .u16Bvact = 240, .u16Bvbb = 15, .u16Bvfb = 4, .u16Hact = 720, .u16Hbb = 57, .u16Hfb = 19, .u16Hpw = 62, .u16Vpw = 6, .u32Pclk = 6750, .bIdv = 1, .bIhs = 1, .bIvs = 1},
    /* 6 - PAL 720x576I25 */
    {.bIop = AX_FALSE, .u16Vact = 288, .u16Vbb = 19, .u16Vfb = 2, .u16Bvact = 288, .u16Bvbb = 20, .u16Bvfb = 3, .u16Hact = 720, .u16Hbb = 68, .u16Hfb = 12, .u16Hpw = 64, .u16Vpw = 5, .u32Pclk = 6750, .bIdv = 1, .bIhs = 1, .bIvs = 1},
    /* 7 - 1280x720@30 */
    {.bIop = AX_TRUE, .u16Vact = 720, .u16Vbb = 20, .u16Vfb = 5, .u16Hact = 1280, .u16Hbb = 220, .u16Hfb = 110, .u16Hpw = 40, .u16Vpw = 5, .u32Pclk = 37125, .bIdv = 1, .bIhs = 1, .bIvs = 1},
    /* 8 - 1280x720@25 */
    {.bIop = AX_TRUE, .u16Vact = 720, .u16Vbb = 20, .u16Vfb = 5, .u16Hact = 1280, .u16Hbb = 220, .u16Hfb = 440, .u16Hpw = 40, .u16Vpw = 5, .u32Pclk = 37125, .bIdv = 1, .bIhs = 1, .bIvs = 1},
    /* 9 - 1280x720@30 PCLK:36M */
    {.bIop = AX_TRUE, .u16Vact = 720, .u16Vbb = 20, .u16Vfb = 5, .u16Hact = 1280, .u16Hbb = 170, .u16Hfb = 110, .u16Hpw = 40, .u16Vpw = 5, .u32Pclk = 36000, .bIdv = 1, .bIhs = 1, .bIvs = 1},
    /* 10 - 1080x1920@60 for dsi burst */
    {.bIop = AX_TRUE, .u16Vact = 1920, .u16Vbb = 20, .u16Vfb = 10, .u16Hact = 1080, .u16Hbb = 8, .u16Hfb = 20, .u16Hpw = 70, .u16Vpw = 10, .u32Pclk = 138500, .bIdv = 0, .bIhs = 0, .bIvs = 0},
};
...
AX_S32 SAMPLE_COMM_VO_StartDev(SAMPLE_VO_DEV_CONFIG_S *pstVoDevConf)
{
    ...
    } else if (pstVoDevConf->u32HdmiMode == VO_HDMI_FORCE_DVI) {
        stVoPubAttr.stHdmiAttr.bEnableHdmi = AX_TRUE;
    ...
    if (pstVoDevConf->enHdmiOutFmt) {
        stVoPubAttr.stHdmiAttr.enHdmiOutFmt = pstVoDevConf->enHdmiOutFmt;
    } else {
        stVoPubAttr.stHdmiAttr.enHdmiOutFmt = AX_HDMI_VIDEO_MODE_RGB444;
    }
    ...
    if (pstVoDevConf->bCscEn) {
        s32Ret = AX_VO_SetCSC(pstVoDevConf->u32VoDev, &pstVoDevConf->stCsc);
        if (s32Ret) {
            SAMPLE_PRT("failed with %#x, dev%d\n", s32Ret, pstVoDevConf->u32VoDev);
            return s32Ret;
        }
...
AX_S32 SAMPLE_COMM_VO_StartChn(SAMPLE_VO_LAYER_CONFIG_S *pstVoLayerConf)
{
    ...
    SAMPLE_PRT("layer %d fifo %d u32Width:%d, u32Height:%d\n", pstVoLayerConf->u32VoLayer, pstVoLayerConf->u32FifoDepth, u32LayerWidth, u32LayerHeight);
    SAMPLE_PRT("layer %d u32ChnFrameOut %d u32Row:%d, u32Col:%d win res %d %d\n", pstVoLayerConf->u32VoLayer, pstVoLayerConf->u32ChnFrameOut, u32Row, u32Col, u32ChnWidth, u32ChnHeight);

    if (pstVoLayerConf->bUseBatch) {
        SAMPLE_PRT("layer%d use batch begin/end function\n", pstVoLayerConf->u32VoLayer);

        s32Ret = AX_VO_BatchBegin(pstVoLayerConf->u32VoLayer);
        if (s32Ret) {
            SAMPLE_PRT("failed with %#x!\n", s32Ret);
            return s32Ret;
        }
    ...
    for (i = 0; i < u32Row; i++) {
        ...
        for (j = 0; j < u32Col; j++) {
            ...
            SAMPLE_PRT("vo chn %d prm u32FifoDepth %d bKeepPrevFr %d bInUseFrOutput %d\n",
                k, tChnAttr.u32FifoDepth, tChnAttr.bKeepPrevFr, tChnAttr.bInUseFrOutput);
    ...
    if (pstVoLayerConf->bUseBatch) {
        s32Ret = AX_VO_BatchEnd(pstVoLayerConf->u32VoLayer);
        if (s32Ret) {
            SAMPLE_PRT("failed with %#x!\n", s32Ret);
            return s32Ret;
        }
