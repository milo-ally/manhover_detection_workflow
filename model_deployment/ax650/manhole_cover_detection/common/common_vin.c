                               ...
                               AX_SNS_CLK_ATTR_T *ptSnsClkAttr, AX_VIN_DEV_ATTR_T *pDevAttr)
{
    ...
    case SMARTSENS_SC410GS:
        memcpy(ptMipiRx, &gSc410gsMipiRx, sizeof(AX_MIPI_RX_DEV_T));
        memcpy(ptSnsAttr, &gSc410gsSnsAttr, sizeof(AX_SNS_ATTR_T));
        memcpy(ptSnsClkAttr, &gSc410gsSnsClkAttr, sizeof(AX_SNS_CLK_ATTR_T));
        memcpy(pDevAttr, &gSc410gsDevAttr, sizeof(AX_VIN_DEV_ATTR_T));
        break;
    case OMNIVISION_OS04A10_2LANE:
        memcpy(ptMipiRx, &gOs04a10Lane2MipiRx, sizeof(AX_MIPI_RX_DEV_T));
        memcpy(ptSnsAttr, &gOs04a10Lane2SnsAttr, sizeof(AX_SNS_ATTR_T));
    ...
    case OMNIVISION_OS04A10_DCG_VS:
        memcpy(ptMipiRx, &gOs04a10MipiRx, sizeof(AX_MIPI_RX_DEV_T));
        memcpy(ptSnsAttr, &gOs04a10SnsAttr, sizeof(AX_SNS_ATTR_T));
        memcpy(ptSnsClkAttr, &gOs04a10SnsClkAttr, sizeof(AX_SNS_CLK_ATTR_T));
        memcpy(pDevAttr, &gOs04a10DevAttr, sizeof(AX_VIN_DEV_ATTR_T));
        break;
    case OMNIVISION_OV48C40:
        memcpy(ptMipiRx, &gOv48c40MipiRx, sizeof(AX_MIPI_RX_DEV_T));
        memcpy(ptSnsAttr, &gOv48c40SnsAttr, sizeof(AX_SNS_ATTR_T));
        memcpy(ptSnsClkAttr, &gOv48c40SnsClkAttr, sizeof(AX_SNS_CLK_ATTR_T));
        memcpy(pDevAttr, &gOv48c40DevAttr, sizeof(AX_VIN_DEV_ATTR_T));
        break;
    case SMARTSENS_SC450AI:
        memcpy(ptMipiRx, &gSc450aiMipiRx, sizeof(AX_MIPI_RX_DEV_T));
                               ...
                               AX_VIN_PIPE_ATTR_T *pPipeAttr, AX_VIN_CHN_ATTR_T *pChnAttr, AX_BOOL *pChnEnable)
{
    ...
    case SAMPLE_SNS_DUMMY:
        ...
        pChnEnable[0] = AX_TRUE;
        pChnEnable[1] = AX_TRUE;
        pChnEnable[2] = AX_TRUE;
        break;
    case OMNIVISION_OS08A20:
    ...
    case SMARTSENS_SC910GS:
        ...
        break;
    case SMARTSENS_SC410GS:
        memcpy(pPipeAttr, &gSc410gsPipeAttr, sizeof(AX_VIN_PIPE_ATTR_T));
        memcpy(&pChnAttr[0], &gSc410gsChn0Attr, sizeof(AX_VIN_CHN_ATTR_T));
        memcpy(&pChnAttr[1], &gSc410gsChn1Attr, sizeof(AX_VIN_CHN_ATTR_T));
        memcpy(&pChnAttr[2], &gSc410gsChn2Attr, sizeof(AX_VIN_CHN_ATTR_T));
        pChnEnable[0] = AX_TRUE;
        pChnEnable[1] = AX_TRUE;
        pChnEnable[2] = AX_TRUE;
    ...
    case OMNIVISION_OS04A10_DCG_VS:
        ...
        memcpy(&pChnAttr[1], &gOs04a10Chn1Attr, sizeof(AX_VIN_CHN_ATTR_T));
        memcpy(&pChnAttr[2], &gOs04a10Chn2Attr, sizeof(AX_VIN_CHN_ATTR_T));
        pChnEnable[0] = AX_TRUE;
        pChnEnable[1] = AX_TRUE;
        pChnEnable[2] = AX_TRUE;
        break;
    case OMNIVISION_OV48C40:
        memcpy(pPipeAttr, &gOv48c40PipeAttr, sizeof(AX_VIN_PIPE_ATTR_T));
        memcpy(&pChnAttr[0], &gOv48c40Chn0Attr, sizeof(AX_VIN_CHN_ATTR_T));
        memcpy(&pChnAttr[1], &gOv48c40Chn1Attr, sizeof(AX_VIN_CHN_ATTR_T));
        memcpy(&pChnAttr[2], &gOv48c40Chn2Attr, sizeof(AX_VIN_CHN_ATTR_T));
        pChnEnable[0] = AX_TRUE;
        pChnEnable[1] = AX_FALSE;
        pChnEnable[2] = AX_FALSE;
        break;
    case SMARTSENS_SC450AI:
        memcpy(pPipeAttr, &gSc450aiPipeAttr, sizeof(AX_VIN_PIPE_ATTR_T));
        memcpy(&pChnAttr[0], &gSc450aiChn0Attr, sizeof(AX_VIN_CHN_ATTR_T));
        memcpy(&pChnAttr[1], &gSc450aiChn1Attr, sizeof(AX_VIN_CHN_ATTR_T));
        memcpy(&pChnAttr[2], &gSc450aiChn2Attr, sizeof(AX_VIN_CHN_ATTR_T));
        pChnEnable[0] = AX_TRUE;
        pChnEnable[1] = AX_TRUE;
        pChnEnable[2] = AX_TRUE;
        break;
                                   ...
                                   AX_VIN_FLASH_LIGHT_TIMING_ATTR_T *ptSnapFlashAttr)
{
    ...
    case OMNIVISION_OS08A20:
        ...
        memcpy(ptSensorVts, &gSc910gsSensorVts, sizeof(AX_VIN_SENSOR_VTS_T));
    ...
    case SMARTSENS_SC910GS:
        ...
        break;
    case SMARTSENS_SC410GS:
        memcpy(ptPowerAttr, &gSc410gsPowerAttr, sizeof(AX_VIN_POWER_SYNC_ATTR_T));
        memset(ptSensorVts, 0, sizeof(AX_VIN_SENSOR_VTS_T));
        memcpy(ptVsyncAttr, &gSc410gsVsyncAttr, sizeof(AX_VIN_SYNC_SIGNAL_ATTR_T));
        memcpy(ptHsyncAttr, &gSc410gsHsyncAttr, sizeof(AX_VIN_SYNC_SIGNAL_ATTR_T));
        memcpy(ptLightSyncInfo, &gSc410gsLightSyncInfo, sizeof(AX_VIN_LIGHT_SYNC_INFO_T));
        memcpy(ptSnapStrobeAttr, &gSc410gsSnapStrobeAttr, sizeof(AX_VIN_STROBE_LIGHT_TIMING_ATTR_T));
        memcpy(ptSnapFlashAttr, &gSc410gsSnapFlashAttr, sizeof(AX_VIN_FLASH_LIGHT_TIMING_ATTR_T));
        break;
    default:
        memcpy(ptPowerAttr, &gSc910gsPowerAttr, sizeof(AX_VIN_POWER_SYNC_ATTR_T));
        memcpy(ptSensorVts, &gSc910gsSensorVts, sizeof(AX_VIN_SENSOR_VTS_T));
...
AX_S32 COMMON_VIN_SetPipeAttr(COMMON_VIN_MODE_E eSysMode, AX_U8 nPipeId, AX_VIN_PIPE_ATTR_T *pPipeAttr,
                              AX_VIN_FRAME_SOURCE_TYPE_E eFrameSrcType)
{
    AX_S32 axRet;
    ...
    if (COMMON_VIN_LOADRAW == eSysMode) {
        if (pPipeAttr->ePipeWorkMode == AX_VIN_PIPE_NORMAL_MODE0) {
        ...
        } else if (pPipeAttr->ePipeWorkMode == AX_VIN_PIPE_NORMAL_MODE1) {
        ...
        if (pPipeAttr->ePipeWorkMode == AX_VIN_PIPE_NORMAL_MODE0) {
            axRet = AX_VIN_SetPipeFrameSource(nPipeId, AX_VIN_FRAME_SOURCE_ID_IFE, eFrameSrcType);
            if (axRet)
                COMM_VIN_PRT("pipe frame source set failed....\n");
        } else if (pPipeAttr->ePipeWorkMode == AX_VIN_PIPE_NORMAL_MODE1) {
            axRet = AX_VIN_SetPipeFrameSource(nPipeId, AX_VIN_FRAME_SOURCE_ID_ITP, eFrameSrcType);
            if (axRet)
                COMM_VIN_PRT("pipe frame source set failed....\n");
        } else if (pPipeAttr->ePipeWorkMode == AX_VIN_PIPE_NORMAL_MODE2) {
            axRet = AX_VIN_SetPipeFrameSource(nPipeId, AX_VIN_FRAME_SOURCE_ID_IFE, eFrameSrcType);
            if (axRet)
                COMM_VIN_PRT("pipe frame source set failed....\n");
            ...
            axRet = AX_VIN_SetPipeFrameSource(nPipeId, AX_VIN_FRAME_SOURCE_ID_AINR, eFrameSrcType);
            if (axRet)
                COMM_VIN_PRT("pipe frame source set failed....\n");
        }
    }
