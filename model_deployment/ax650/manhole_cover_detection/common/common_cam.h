...
typedef struct {
    ...
    AX_BOOL                             bRegister3A[AX_VIN_MAX_PIPE_NUM];
    ...
    AX_VIN_CHN_ATTR_T                   tChnAttr[AX_VIN_MAX_PIPE_NUM][AX_VIN_MAX_CHN_NUM];
    AX_VIN_EXT_RAW_DUMP_ATTR_T          tExtRawDumpAttr[AX_VIN_MAX_PIPE_NUM];
    AX_ISP_DEPEND_ATTR_T                tIspDependAttr[AX_VIN_MAX_PIPE_NUM];
    AX_BOOL                             bChnEnable[AX_VIN_MAX_PIPE_NUM][AX_VIN_MAX_CHN_NUM];
    AX_BOOL                             bEisEnable[AX_VIN_MAX_PIPE_NUM];
    AX_VIN_SENSOR_VTS_T                 tSensorVts;
