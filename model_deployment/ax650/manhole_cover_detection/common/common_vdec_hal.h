...
#define MIN_BUFFER_SIZE  (2 * 1024 * 1024)
...
typedef struct axSAMPLE_VDEC_CHN_ATTR_S {
    AX_BOOL bEnable;
    AX_VDEC_CHN_ATTR_T stAttr;
} SAMPLE_VDEC_CHN_ATTR_T;
...
typedef struct axSAMPLE_VDEC_FUNC_ARGS {
    ...
    SAMPLE_VDEC_CHN_ATTR_T stVdecChnAttr[AX_VDEC_MAX_CHN_NUM];
