...
AX_S32 COMMON_ISP_RegisterSns(AX_U8 pipe, AX_U8 nDevId, AX_SNS_CONNECT_TYPE_E eBusType, AX_SENSOR_REGISTER_FUNC_T *ptSnsHdl);
...
AX_S32 COMMON_ISP_ResetSnsObj(AX_U8 pipe, AX_U8 nDevId, AX_SENSOR_REGISTER_FUNC_T *ptSnsHdl);
...
AX_S32 COMMON_ISP_DeInit(AX_U8 pipe, AX_BOOL bRegister3A);
